...
import static com.example.anthonyeisenback.retrofitworkshop.MainActivity.ARTIST_NAME;
import static com.example.anthonyeisenback.retrofitworkshop.MainActivity.SONG_TITLE;
...
public class LyricsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String strtext = getArguments().getString(ARTIST_NAME,SONG_TITLE);
